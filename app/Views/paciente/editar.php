        ...
        <form method="POST" action="<?= base_url() ?>paciente/editar/<?= $user_data['id_paciente'] ?>"
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg">
                ...
                <div id="main" class="grid grid-rows-3 grid-flow-col">
                    ...
                    <div class="relative w-full mb-3 px-5">
                        <label class="block uppercase  text-blueGray-600 text-xs font-bold mb-2"
                            ...
                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            placeholder="fecha nacimiento" name="fecha_nacimiento"
                    ...
                    <div class="relative w-full mb-3 px-5">
                        <div id="pecesSelecr"
                            ...
                            <select id="sexo" name="sexo" autocomplete="country-name"
                                ...
                                <option <?= $user_data['sexo'] == 'Hombre' ? 'selected' : '' ?> value="Hombre">Hombre
                                </option>
                                <option <?= $user_data['sexo'] != 'Hombre' ? 'selected' : '' ?> value="Mujer">Mujer
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="relative w-full mb-3 px-5">
                        ...
                        <input type="text"
                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            placeholder="lugar familia" name="lugar_familia"
                            value="<?= $user_data['lugar_familia'] ?>" />
                    </div>
                    ...
                    <div class="relative w-full mb-3 px-5">
                        ...
                        <input type="text"
                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            placeholder="ocupacion" name="ocupacion" value="<?= $user_data['ocupacion'] ?>" />
                    </div>
                    <div class="relative w-full mb-3 px-5">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2"
                    ...
                    <div class="relative w-full mb-3 px-5">
                        ...
                        <input type="text"
                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            placeholder="escolaridad" name="escolaridad" value="<?= $user_data['escolaridad'] ?>" />
                    </div>
                    <div class="relative w-full mb-3 px-5">
                        <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2"
                        ...
                        <input type="text"
                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            placeholder="estado_civil" name="estado_civil" value="<?= $user_data['estado_civil'] ?>" />
                    </div>
                    <div class="relative w-full mb-3 px-5">
                        <div id="pecesSelecr"
                            class="col-span-6 sm:col-span-3 rounded-md border border-gray-300 bg-white py-2 px-3">
                  ...
                  foreach ($estudiantes as $estudiante) :
                    ...
                    <div class="relative w-full mb-3 px-5">
                        <div id="pecesSelecr"
                            ...
                            <select id="sexo" name="estado" autocomplete="country-name"
                                class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                <option value="">Seleccionen un estado</option>
                                <option <?= $user_data['estado_civil'] == 'Activo' ? 'selected' : '' ?> value="Activo">
                                    Activo</option>
                                <option <?= $user_data['estado_civil'] == 'Activo' ? 'selected' : '' ?>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg">
                    ...
                    <div id="main" class="grid grid-rows-3 grid-flow-col">
                        ...
                        <div class="relative w-full mb-3 px-5 ">
                            <label class="block uppercase  text-blueGray-600 text-xs font-bold mb-2"
                                for="grid-password">motivo de consulta</label>
                            <input type="text"
                                class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                placeholder="motivo_consulta"
                                value="<?= isset($ficha['motivo_consulta']) ? $ficha['motivo_consulta'] : '' ?>"
            ...
            <input type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="situacion_ambiente" name="situacion_ambiente" />
                        ...
                        <div class="relative w-full mb-3 px-5 ">
                            ...
                            <input type="text"
                                class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                placeholder="historia_personal"
                                value="<?= isset($ficha['historia_personal']) ? $ficha['historia_personal'] : '' ?>"
                                name="historia_personal" />
                        </div>
                        <div class="relative w-full mb-3 px-5 ">
                            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2"
            ...
            <input type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="plan_terapeutico" name="plan_terapeutico" />
              ...
              <input  type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="nombre" value="<?= $ficha['nombre'] ?>" name="nombre" />
            </div> -->
                    </div>
                    ...
                    <table class="items-center w-full dsm py-4">
                        ...
                        <tbody>
                            <tr class="main-dsm">
                                ...
                                <td>
                                    <div class="relative w-full mb-3 px-5 ">
                                        <input type="text" value="<?= $ficha['hermanos'] ?>"
                                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                ...
                                <td>
                                    <div class="relative w-full mb-3 px-5 ">
                                        <input type="text" value="<?= $ficha['observacionessituacion'] ?>"
                                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                ...
                                <td>
                                    <div class="relative w-full mb-3 px-5 ">
                                        <input type="text" value="<?= $ficha['genograma'] ?>"
                                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
