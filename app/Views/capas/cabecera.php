...
<body class="text-blueGray-700 antialiased">
    <div id="root">
        <nav id='amburguer'
            class="amburguer md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
            <div id="amburguer"
                class="amburguer md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
                <button
                ...
                <table>
                    ...
                    <th>
                        <button type="button"
                            class="cursor-pointer text-black  px-3 py-1 text-xl leading-none bg-transparent rounded border border-solid border-transparent"
                            onclick="toggleNavbarAMnueg('amburguer')">
                ...
                <div id='amburguer'
                    class="hidden md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
        ...
        <!-- <div id='amburguerMain' class="amburguerMain relative md:ml-64 bg-blueGray-50">
            ...
            <nav
                class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                <button onclick="toggleNavbarAMnuegOpen('amburguer')" id="btnOpen"
                    class="btnOpen cursor-pointer text-white px-3 hidden py-1 text-xl leading-none bg-transparent rounded border border-solid border-transparent"
                    type="button" onclick="toggleNavbar('example-collapse-sidebar')">
                    <i class="fas fa-bars"></i>
                </button>
                <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
