    ...
    if ($type == 'input') {
        return
            '<div class="relative w-full mb-3 px-5 ">
                ...
                <input type="text" value="'.$value.'" class=" text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" placeholder="'.$label.'" name="custom_fields['.$name.']" />
            </div>';
    }
    if ($type == 'checkbox') {
        return
